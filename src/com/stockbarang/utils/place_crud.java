 ...
 * @author asus
 */
public class place_crud extends javax.swing.JFrame {
...
//        IntelliJTheme.setup(place_crud.class.getResourceAsStream("/template.theme.json"));
        ...
        try {
            if("".equals(namaInput.getText())){
                ...
                if(JOptionPane.showConfirmDialog(null, "Sudah benar?") ==  0){
                    String column = action.equals("add") || action.equals("") ? namaInput.getText(): "place_name='"+namaInput.getText()+"'";
                    String sql = action.equals("add") || action.equals("") ? q.insertPlace(column) : q.updateItemsWhereId("place", id, column);
    ...
    private void getItemsByID(String id){
        try {
            String sql = q.getAllWhereId("place", id);
            st = conn.con.createStatement();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(place_crud.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new place_crud("", "").setVisible(true);
            }
        });
    }
